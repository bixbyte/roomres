...
<html lang="en" manifest="cache.appcache">
	<head>
		...
		<title>UEAB | Room Reservation - Password Recovery</title>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3735bf', endColorstr='#23227a',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */" >
		...
		<div class="login-wrapper" >
				...
				<div class="form-group  no-label">
                                   ...
                                   <div>
                                       <div style="color:graytext;"><center style="font-weight:bold;">The password will be mailed to you</center></div>
                                   </div>
				</div>
                        
                         <input type="hidden" name="act" value="request_password" readonly /> 
                  ...
                  $(function(){
                      ...
                      $("#recover").click(function(){
                          ...
                          if(usr.length < 5){
                            ...
                            $.post("proc_adds.php", {act: "request_password", username: usr }, 
