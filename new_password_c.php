...
<html lang="en" manifest="cache.appcache">
    <head>
        ...
        <title>UEAB | Room Reservation | Admin Password Recovery</title>
        ...
        <div class="login-wrapper" >
            ...
            <div id="form">
                <div class="form-group has-feedback lg left-feedback no-label">
                    <input type="text" class="form-control no-border input-lg rounded"  id="username" required="required" placeholder="Admin Username/ id number" autofocus>
                ...
                <div class="form-group">
                    <button type="submit" id="recover" class="btn btn-success btn-lg btn-perspective btn-block">RECOVER PASSWORD</button>
                </div>
            </div>
            <p class="text-center"><strong><a href="c_login.php" >Proceed to Login</a></strong></p>
            ...
            $(function(){
                ...
                $("#recover").click(function(){
                    ...
                    if(usr.length < 5){
                        ...
                        $("#repondre").html( __LOADING );
                        $.post("proc_adds.php", {act: "request_password_c", username: usr }, 
