												...
												<div class="row">
                                                    ...
                                                    <?php
		                                                    ...
		                                                    if(@$_SESSION['u56_res'] == 0 || @$_SESSION['u56_rnum'] == 0){
			                                                    ...
			                                                    if(@$status == 1 || @$times < 1){
                                                                    ...
                                                                    while(@$resresults = @mysqli_fetch_array($residencesss)){
                                                                        ...
                                                                        $percent = ( ( ($res_['SUM(curr_capacity)'] == '') ? 1 : $res_['SUM(curr_capacity)'] ) / ( ($res_['SUM(max_capacity)'] == '') ? 1 : $res_['SUM(max_capacity)'] ) * 100 ) ;
                                                                       
                                                                        
                                                                       if( $percent == 100 ){
                                                                           $chart_color = " bg-danger img-circle";
                                                                       }elseif( $percent <= 50 ){
                                                                           $chart_color = "bg-success img-circle";
                                                                       }elseif( $percent <= 75){
                                                                           $chart_color = "bg-info img-circle" ;
                                                                       }else{
                                                                           $chart_color = "bg-warning img-circle";
                                                                       }
													    ...
													    <div class="col-xs-6 text-center">
														    ...
														    <span class="chart '.$chart_color.' chart-widget-pie widget-easy-pie-'.$i.'" data-percent="'.
                                                                            $percent
					                            ...
					                            <div class="alert alert-success bg-success alert-bold-border text-center fade in alert-dismissable" id="loader">
					                              <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><!--&times; --></button>
                                                    ...
                                                    if(@$_SESSION['u56_res'] == 0 || @$_SESSION['u56_rnum'] == 0){
			                                            ...
			                                            if(@$status == 1 || @$times < 1){
                                                            echo "<code> AWAITING RESIDENCE SELECTION</code><br><br> <code>Click on a residence circle to proceed</code>";
                                                        }else {
