...
if(@$_SESSION['u56_res'] != '' && @$_SESSION['u56_res'] != 0 && @$_SESSION['u56_rnum'] != '' ){ 
    ...
    echo "n/a";
                    ...
                    <div class="the-box no-border" style="background: #E8E9EE;">
                        
                        <div class="owl-carousel shop-carousel  " style="display:block; z-index: 0;"  >
...
while($mate = mysqli_fetch_array($rmate)){
    ...
    if(@strtoupper($mate['s_idnum']) != @strtoupper($_SESSION['l031n45'])){	
        ...
        echo ' 
                ...
                <div class="the-box darker fly-out round text-center no-border col-lg-3" style="z-index: 0;">
