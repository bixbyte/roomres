...
<html>
  ...
  <head>
    ...
    id="theme" />
    <title>UEAB ROOMRES| LOGIN</title>
  ...
  <div class="section" id="section1">
    <div class="column ui-sortable" id="column1">
      <div class="fb-item fb-100-item-column" id="item1" style="opacity: 1;">
        <div class="fb-header fb-item-alignment-center">
          <h2 style="display: inline;">
            UEAB | Room Reservation Login
          </h2>
        </div>
      </div>
      <div class="fb-item fb-50-item-column" id="item17">
        <div class="fb-grouplabel">
          <label id="item17_label_0" style="display: inline;">School ID Number</label>
        </div>
        <div class="fb-input-box">
          <input name="username" id="item17_text_1" required type="text" maxlength="254"
      ...
      <div class="fb-item fb-50-item-column" id="item24">
        ...
        <div class="fb-input-box">
          <input name="passwd" id="item24_password_1" type="password" required maxlength="254"
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3735bf', endColorstr='#23227a',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */;"
  ...
  <div style="width:auto; height:30px; display:block;">
  	<div style="float:left; width:200px; " align="center"><a href="new_password.php" >Having Password Trouble? </a></div>
    <div style="float:right; width:200px;" align="center"><a href="new_reservant.php" >SIgnUp </a></div>
  </div>
  <br />
</form>
</body>
