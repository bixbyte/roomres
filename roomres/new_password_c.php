...
<html>
  ...
  <head>
    ...
    id="theme" />
    <title>UEAB RoomRes|Admin Password Recovery</title>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3735bf', endColorstr='#23227a',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */">
  ...
  <div class="section" id="section1">
    <div class="column ui-sortable" id="column1">
      ...
      <div class="fb-item fb-75-item-column" id="item2">
        <div class="fb-grouplabel">
          <label id="item2_label_0" style="display: inline;">Admin ID Number / Username</label>
        </div>
        <div class="fb-input-box">
          <input name="username" id="item2_text_1" required type="text" maxlength="254"
          placeholder="SIDNUM0101" autocomplete="off" data-hint="Required. 
  ...
  <input type="hidden" name="act" value="request_password_c" readonly />
