...
<script type="text/javascript" src="form_init.js" id="form_init_script"
    ...
    id="theme" />
    <title>UEAB | Add Residence</title>
...
<div id="Tabs1">
  <ul>
    <li><a href="#tabs-1">ADD RESIDENCE</a></li>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3735bf', endColorstr='#23227a',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */">
    ...
    <div class="column ui-sortable" id="column1">
      ...
      <div class="fb-item fb-50-item-column" id="item2">
        <div class="fb-grouplabel">
          <label id="item2_label_0" style="display: inline;">Residence Name</label>
        </div>
        <div class="fb-input-box">
          <input name="name" id="item2_text_1" required type="text" maxlength="254"
          placeholder="residence Name" autocomplete="off" data-hint="Required" />
      ...
      <div class="fb-item fb-50-item-column" id="item11">
        <div class="fb-grouplabel">
          <label id="item11_label_0" style="display: inline;">Gender</label>
        </div>
        <div class="fb-dropdown">
          <select name="gender" id="item11_select_1" required data-hint="Required">
            <option id="item11_0_option" selected value="">
              Choose one
            </option>
            <option id="item11_1_option" value="m">
              Male
            </option>
            <option id="item11_2_option" value="f">
              Female
            </option>
            <option id="item11_3_option" value="a">
              Either
            </option>
          </select>
        </div>
  ...
  <input type="hidden" value="new_residence" name="act" readonly />
