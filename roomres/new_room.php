...
<div id="Tabs1">
  <ul>
    <li><a href="#tabs-1">ADD ROOM</a></li>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#3735bf', endColorstr='#23227a',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */">
  ...
  <div class="section" id="section1">
    <div class="column ui-sortable" id="column1">
      ...
      <div class="fb-item fb-50-item-column" id="item14">
        <div class="fb-grouplabel">
          <label id="item14_label_0" style="display: inline;"><i>n</i><sup>th</sup> Room</label>
        </div>
        <div class="fb-input-box">
          ...
          />
          <div class="fb-hint" style="color: rgb(136, 136, 136); font-style: normal; font-weight: normal;">
            For adding multiple [numeric-only rooms]
          </div>
        </div>
      </div>
          ...
          <select name="residence" id="item15_select_1" required data-hint="">
             <option value=""> Pick One   </option>
                <?php
					...
					//Add "WHERE gender='$_SESSION[u56_gender]'" to limit the gender of the viewed residences 
  ...
  <input type="hidden" value="new_room" name="act" readonly />
  
  <div class="fb-captcha fb-item-alignment-center" id="fb-captcha_control"
  style="display: none; cursor: default;">
    <img src="recaptchawhite.png" />
  </div>
