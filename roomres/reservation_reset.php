...
<div id="Tabs1">
  <ul>
    <li><a href="#tabs-1">RESERVATION RESET</a></li>
    ...
    <div class="column ui-sortable" id="column1">
      ...
      <div class="fb-item fb-50-item-column" id="item12" style="opacity: 1;">
        <div class="fb-grouplabel">
          <label id="item12_label_0" style="display: inline;">Student ID</label>
        </div>
        <div class="fb-input-box">
          <input name="id_number" id="item12_text_1" required type="text" maxlength="254"
      ...
      <div class="fb-item fb-50-item-column" id="item16" style="opacity: 1;">
        <div class="fb-static-text">
          <p style="color: rgb(138, 134, 138);">
            Enter The Student ID Number of the student that you would like to allow
            to re-select a room.
          </p>
        </div>
      </div>
